...
NCountry = {
	...
	NUCLEAR_PRODUCTION_SCALE = 500,					-- +1 nuclear_production gives 1 nuke per year
...
NMilitary = {
	...
	NUKE_MIN_DAMAGE_PERCENT = 3,					-- Minimum damage from nukes as a percentage of current strength/organisation
	NUKE_MAX_DAMAGE_PERCENT = 5,					-- Minimum damage from nukes as a percentage of current strength/organisation
	...
	STRATEGIC_SPEED_BASE = 90.0,                 	-- Speed of strategic redeployment
	STRATEGIC_INFRA_SPEED = 90.0,                   -- Max of additional speed gained trouh=gh level for strategic redeployment per infra
