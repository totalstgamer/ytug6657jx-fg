...
NDiplomacy = {
	...
	WARGOAL_PER_JUSTIFY_AND_WAR_COST_FACTOR = 2,	-- Cost factor per nation at war with or justifying against
	BASE_BOOST_PARTY_POPULARITY_DAILY_PP = 0.25, 	-- Daily pp cost for boost party popularity
	BASE_BOOST_PARTY_POPULARITY_DAILY_DRIFT = 0.11, 	-- Daily amount of popularity that will be added by the activity.
	BASE_STAGE_COUP_DAILY_PP = 0.5,					-- Daily pp cost for staging a coup
	BASE_STAGE_COUP_TOTAL_COST = 160, 				-- Equipment consume factor for stage coup.
	...
	TENSION_GENERATE_WARGOAL = 0.5,					-- Amount of tension generated by generating a wargoal against a country
	...
	TENSION_TIME_SCALE_START_DATE = "2060.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
	...
	TENSION_LIBERATE = -3,							-- Amount of tension generated by liberating a country. 
	TENSION_CAPITULATE = 0.80,						-- Scale of the amount of tension created by a countries capitulation.
...
NCountry = {
	...
	NUCLEAR_PRODUCTION_SCALE = 600,					-- +1 nuclear_production gives 1 nuke per year
	...
	LOCAL_MANPOWER_ACCESSIBLE_NON_CORE_FACTOR = 0.20,  -- accessible recruitable factor base
	...
	STATE_VALUE_BUILDING_SLOTS_MULT = 11.0,			-- The Value of each building slot in a state ( Value is used to determine costs in peace conference and PP cost to occupy )
...
NMilitary = {
	...
	NUKE_MIN_DAMAGE_PERCENT = 0.2,					-- Minimum damage from nukes as a percentage of current strength/organisation
	NUKE_MAX_DAMAGE_PERCENT = 0.4,					-- Minimum damage from nukes as a percentage of current strength/organisation
	EQUIPMENT_REPLACEMENT_RATIO = 0.1,				-- Equipment min ratio after blocking the equipment type
	NUKE_DELAY_HOURS = 7,							-- How many hours does it take for the nuclear drop to happen
	...
	STRATEGIC_SPEED_BASE = 60.0,                 	-- Speed of strategic redeployment
	STRATEGIC_INFRA_SPEED = 60.0,                   -- Max of additional speed gained trouh=gh level for strategic redeployment per infra
...
NAir = {
	...
	STRATEGIC_BOMBER_NUKE_AIR_SUPERIORITY = 0.55,		-- How much air superiority is needed for a tactical bomber to be able to nuke a province
...
NAI = {
	...
	DILPOMATIC_ACTION_DECLARE_WAR_WARGOAL_BASE = 45, -- Base diplomatic action score bonus to go to war per wargoal
	...
	DIPLOMACY_BOOST_PARTY_COST_FACTOR = 90.0,	-- Desire to boost party popularity subtracts the daily cost multiplied by this
	DIPLOMACY_STAGE_COUP_COST_FACTOR = 90.0,	-- Desire to stage a coup subtracts the cost multiplied by this
	...
	MAX_EXTRA_WARGOAL_GENERATION = 10,					-- AI may want to generate wargoals against weak minors to get at larger enemy, but never more that this at any given time.
	...
	NUKE_MISSION_FACTOR = 2,							-- AI nuke mission factor
